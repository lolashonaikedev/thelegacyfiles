    ...
    for i in range(len(popList)):
       ...
       for j in range(len(popList[i])):
        if j!=len(popList[i])-1:
          ...
          pstr+=str(popList[i][j])+"\n"
       popFile.write(pstr)
    outfile=open("ARCircle.html","w")
    message2="""<!DOCTYPE html>
<html>
<head> <title> AR Path Visualization </title>
<script type="text/javascript" src="d3.min.js""></script>
</head>
<body>
<h1> Alien Rescue Data Visualization </h1>

<svg width="1000" height="1000">

  <ellipse cx="500" cy="500" rx="100" ry="100"
    style="fill:white;stroke:black;stroke-width:2"       />
 <text x= "410" y="507" fill="black" font-size="20">0</text>
 <text x="433" y="455" fill="black" font-size="20">1</text>
 <text x="493" y="420" fill="black" font-size="20">2</text>
 <text x="557" y="455" fill="black" font-size="20">3</text>
 <text x="580" y="507" fill="black" font-size="20">4</text>
 <text x="550" y="560" fill="black" font-size="20">5</text>
 <text x="493" y="580" fill="black" font-size="20">6</text>
  <text x="413" y="550" fill="black" font-size="20">Null</text>
  <text x="473" y="500" fill="black" font-size="20">Score</text>
  <line x1= "300px" y1="500px" x2="400px" y2="500px" stroke="black"/>
   <line x1= "500px" y1="400px" x2="500px" y2="300px" stroke="black"/>
...
"""
   ...
   # outfile.close()
    ...
    for i in range(len(pop1)):
          ...
          lineStr="<ellipse id=\"pop1\" cx=\"560px\" cy=\"440\" rx=\"50\" ry=\"\" transform=\" rotate(45,580,460) translate(0,"+str(posLine)+")\""+" style=\" stroke:"+strokeCol+"; stroke-width:0.5; fill:"+strokeCol+";\"/>"  
          outfile.write(str(lineStr)+"\n")
    #outfile.close()
