...
public class PracticeAnimation extends PApplet {
...
public void fileSelected(File selection) {
  ...
  int stage = PApplet.parseInt(arrTokens1[0])+'\n';
 
    if(1 == PApplet.parseInt(arrTokens1[0])){
     freqTools1.append(arrTool[i]);
     freqCat1.append(arrCategory[i]);
 }
  if(2 == PApplet.parseInt(arrTokens1[0])){
     freqTools2.append(arrTool[i]);
     freqCat2.append(arrCategory[i]);
  }
   if(3 == PApplet.parseInt(arrTokens1[0])){
    freqTools3.append(arrTool[i]);
     freqCat3.append(arrCategory[i]);
  }
 if(4 == PApplet.parseInt(arrTokens1[0])){
...
class star { 
  ...
  static public void main(String[] passedArgs) {
    String[] appletArgs = new String[] { "PracticeAnimation" };
    if (passedArgs != null) {
